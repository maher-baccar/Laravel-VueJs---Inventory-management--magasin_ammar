...
export default {
    ...
    mutations: {},
    actions: {
        All_STOREKEEPERS({ dispatch, commit, getters }) {
        ...
        ADD_STOREKEEPER({ dispatch, commit, getters }, payload) {
            return new Promise((resolve, reject) => {
                axios
                    .post('storekeepers/', payload)
                    .then(response => {
                        resolve(response.data.data)
                    })
                    .catch(err => {
        ...
        UPDATE_STOREKEEPER({ dispatch, commit, getters }, data) {
            let { id, payload } = data
            return new Promise((resolve, reject) => {
                axios
                    .put('storekeepers/' + id, payload)
                    .then(response => {
                        resolve(response.data.data)
                    })
                    .catch(err => {
        ...
        DELETE_STOREKEEPER({ dispatch, commit, getters }, id) {
            return new Promise((resolve, reject) => {
                axios
                    .delete('storekeepers/' + id)
                    .then(response => {
                        resolve(response.data.data)
                    })
                    .catch(err => {
